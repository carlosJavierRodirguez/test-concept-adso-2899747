...
public abstract class ABaseInteractionsService<T extends AuditableEntityInteractions>
        implements IBaseServiceInteractions<T> {
    /**
     * Retrieves the repository associated with the entity.
     *
     * @return The repository associated with the entity.
     */
    protected abstract IBaseRepositoryInteractions<T, String> getRepository();
