...
import com.example.Filmoteca.users.entity.AuditableEntityUsers;
...
public abstract class ABaseUsersService<T extends AuditableEntityUsers> {
    /**
     * Retrieves the repository associated with the entity.
     *
     * @return The repository associated with the entity.
     */
    protected abstract IBaseRepositoryUsers<T, String> getRepository();
