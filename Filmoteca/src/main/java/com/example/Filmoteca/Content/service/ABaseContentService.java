...
abstract public class ABaseContentService <T extends AuditableEntityContent> implements IBaseServiceContent<T>{
     ...
     */
    protected abstract IBaseRepositoryContent<T, String> getRepository();
